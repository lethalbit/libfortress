...
#pragma once
#if !defined(libfortress_internal_zlib_hh)
#define libfortress_internal_zlib_hh
...
#include <libfortress/internal/fd.hh>
...
namespace Fortress::Internal {
	using namespace Fortress::Internal::Units;
...
#endif /* libfortress_internal_zlib_hh */
